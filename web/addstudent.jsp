...
<form method="post" action="updatestudent.jsp">
    ...
    <p> <b>Student Department </b></p>&emsp;&emsp; <select name="batch" id="batch"> <option>C.S</option><option>B.A</option><option>B.C.A</option><option>B.Com</option><option>B.B.A</option></select>
