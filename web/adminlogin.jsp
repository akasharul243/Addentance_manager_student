...
<form method="post" action="admincheck.jsp">
    ...
    <p> <b>Your id Please: </b></p> <input type="text" name="id" id="id"  required placeholder="Enter Your ID Please">
    <p> <b>Your password Please </b></p> <input type="password" name="password" id="password"  required placeholder="Enter Password Please">
